...
{
    using Sarkaran.Http.Client.Extensibility;
    using Sarkaran.Http.Client.Internal;
    using Sarkaran.Http.Client.Retry;
    using System;
    ...
    public class FluentClient : IClient
    {
        ...
        /// <summary>Set the API Key as Authorization header.</summary>
        /// <param name="apiKey">The API Key header value.</param>
        public IClient SetApiKey(string apiKey)
        {
            this.BaseClient.DefaultRequestHeaders.Remove("Authorization");
            this.BaseClient.DefaultRequestHeaders.Add("Authorization", apiKey);
            return this;
        }
        ...
        private void SetDefaultUserAgent()
        {
            ...
            this.SetUserAgent($"FluentHttpClient/{version} (+PowrOfYou)");
        }
