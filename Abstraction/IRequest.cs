...
namespace Sarkaran.Http.Client
{
    ...
    public interface IRequest
    {
        ...
        /// <param name="argument">An strongly typed object where the property names and values are used.</param>
        /// <returns>Returns the request builder for chaining.</returns>
        /// <example><code>client.WithArgument&lt;Sample&gt;(sampleData)</code></example>
        IRequest WithArgument<T>(T argument);
